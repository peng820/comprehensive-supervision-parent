package com.evi.common.core.util.exception;
...
public class BootExceptionHandler {
	...
	public R<?> handleRRException(BootException e){
	...
	public R<?> HttpRequestMethodNotSupportedException(HttpRequestMethodNotSupportedException e){
		...
		return R.failed(405,sb.toString());
	}
    ...
    public R<?> handleMaxUploadSizeExceededException(MaxUploadSizeExceededException e) {
    	log.error(e.getMessage(), e);
        return R.failed("文件大小超出100MB限制, 请压缩或降低文件质量! ");
    }
